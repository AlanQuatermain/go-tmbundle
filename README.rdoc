...
+if+::     lays out a plain if statement, with curly braces, tab stop on the condition. This is here because an 'if' statement in Go MUST use braces it seems, and this is as good a way as any to force myself (and others) to remember that.
